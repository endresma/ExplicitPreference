...
public class OrderedGraph {
     ...
     */
    private ArrayList<Object[]> combinedKeys = new ArrayList<>();
...
//    private HashMap<Object[], int[]> combinedSignatures = new HashMap<>();
    private HashMapWrapper combinedSignatures = new HashMapWrapper();
    private Map<Object, int[]> maxSignatureValues = new HashMap<>();
    /**
     * signatures for each order
     */
    private HashMap<Object, Object> signatureAssignments = new HashMap<>();
    ...
    public static void main(String[] args) {
        ...
        OrderedPair a2 = new OrderedPair(3, 1);
        OrderedPair a3 = new OrderedPair(null,4);
//        OrderedPair a4 = new OrderedPair(2,5);
...
//        ArrayList<OrderedPair> orderedPairs2 = new ArrayList<OrderedPair>();
//        OrderedPair a_1 = new OrderedPair(2, 1);
//        OrderedPair a_2 = new OrderedPair(null, 3);
...
//        HashMapWrapper wrap = graph.getKeySignatureAssignments();
//        Object[] o = new Object[]{0,0};
//        boolean cont = wrap.containsKey(o);
//        int[] val = wrap.get(o);
//        System.out.println(val);
    ...
    private void buildStandardGraph() {
        ...
        DirectedGraph<Object, DefaultEdge> temp_gr = new DefaultDirectedGraph<Object, DefaultEdge>(
                DefaultEdge.class);
    ...
    private void breadthSearch() {
        ...
        signatureAssignments.put(currentOrder, signatures);
    ...
    protected void combineSignatures() {
        ...
        for (int i = 0; i < order_list.size(); i++) {
            ...
            Object order = order_list.get(i);

            Set<Object> set = ((HashMap<Object, ArrayList<Integer>>) signatureAssignments
                    .get(order)).keySet();
            ...
            while (iter.hasNext()) {
                ...
                signaturesOfSomeOrder.put(key,
                        ((HashMap<Object, ArrayList<Integer>>) signatureAssignments
                                .get(order)).get(key));
        ...
        Object[] values = new Object[order_list.size()];
        ...
        for (int j = 0; j < combinedKeys.size(); j++) {
            ...
            for (int k = 0; k < combinedKeys.get(j).length; k++) {
                ArrayList<Integer> einzeln_signatur; //= new ArrayList<Integer>();
        ...
        for (Object key_o : combinedSignatures.keySet()) {
            Object[] key = (Object[])key_o;
            System.out.print("\n[ ");
            for (int key_ = 0; key_ < key.length; key_++) {

                System.out.print(key[key_]);
                System.out.print(" ");
            }
            System.out.print("] ");
            System.out.print(": ");
            int[] val = combinedSignatures.get(key);
            System.out.print("[ ");
    ...
    private void getCombinedSignatureValueArray() {
        ...
        for (int i = 0; i < l; i++) {
            ...
            for (Object combined_key : combinedSignatures.keySet()) {
                Object[] tmp = (Object[])combined_key;
                if (combinedSignatures.get(tmp)[i] > max) {
                    max = combinedSignatures.get(tmp)[i];
                }
            }
    ...
    // random signatures
    public HashMapWrapper getKeySignatureAssignments() {
    ...
    private void printKeySignatureAssignments(){
        ...
        for (Object order: orders){
            ...
            while(iter.hasNext()){
                Object key = iter.next();
                System.out.print("\n[ "+ key.toString()+ " ] : [ ");
                for (int i = 0; i < ((HashMap<Object, ArrayList<Integer>>) signatureAssignments
                        .get(order)).get(key).size(); i++) {
                    System.out.print(((HashMap<Object, ArrayList<Integer>>) signatureAssignments
                            .get(order)).get(key).get(i));
                    System.out.print(" ");
                }
                System.out.printf("]");
            }
